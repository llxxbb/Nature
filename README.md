...
**高阶服务治理平台**：Nature 认为当前服务治理的核心矛盾在于服务的单一职责与服务间关系繁杂从而导致难以维护之间的矛盾。关系繁杂的本质问题是服务间的**直接控制**，控制强有力的方式是内聚而不是耦合；耦合暗示了双方是平等的协作，而不是不平等的控制。Nature 接管了控制，从而使服务治理得到质的提升。请参考：[服务治理咋这么难？我想得换个治法了](https://www.cnblogs.com/llxxbb/p/serviceGovernance.html)

**流程编排工具**：Nature 可以用数据来编排业务流程，你没有看错，不是用功能来编排，因为数据可以直达业务核心！Nature **用数据来连接世界**，避免你陷入功能的泥潭而迷失目标。Nature 用简单统一的规则来代替具象多变的控制，只要你愿意 Nature 能帮助你抽取所有的业务控制逻辑问题，让你的系统进化出大脑。Nature 的自然观、时空观、哲学观以及数学观请参见：[Nature 架构思想](doc/ZH/help/architecture.md)。

**低代码平台**：业务系统中最占工作时间的、最复杂的，最难维护的，最不显山露水的就是非功能性开发，而 Nature 可以帮你简化掉这80%的成本。请参考：[现有开发模式的问题分析及解决方法](doc/ZH/natureBusinessValue.md)。
